...
#define EOL_PKT_TEST_REQUEST   0x65
...
#define EOL_TEST_REQUEST_SIZE  6
...
_Static_assert(sizeof(LoRaEOLTestRequest) == EOL_TEST_REQUEST_SIZE,
               "LoRaEOLTestRequest size mismatch");
